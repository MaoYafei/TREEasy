...
os.system('python Spetree.py -d %s -s %s -g %s -b %d -r %s -n %d -k %d -t %d' % (
seq_file, species_namefile, gene_namefile, boot_value, roottaxon, Net_num, cross_value, thread_number))
